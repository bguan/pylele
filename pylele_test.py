...
from api.core import test_api, DEFAULT_TEST_DIR
...
class PyleleTestMethods(unittest.TestCase):
    ...
    from pylele2.frets import test_frets, test_frets_mock
    from pylele2.fretboard import test_fretboard, test_fretboard_mock
    from pylele2.fretboard_dots import (
        test_fretboard_dots,
        test_fretboard_dots_mock,
    )
    from pylele2.fretboard_spines import (
        test_fretboard_spines,
        test_fretboard_spines_mock,
    )
    from pylele2.fretboard_joint import (
        test_fretboard_joint,
        test_fretboard_joint_mock,
    )
    from pylele2.top import test_top, test_top_mock
    from pylele2.strings import test_strings, test_strings_mock
    from pylele2.nut import test_nut, test_nut_mock
    from pylele2.spines import test_spines, test_spines_mock
    from pylele2.head import test_head, test_head_mock
    from pylele2.neck_joint import test_neck_joint, test_neck_joint_mock
    from pylele2.neck import test_neck, test_neck_mock
    from pylele2.bridge import test_bridge, test_bridge_mock
    from pylele2.guide import test_guide, test_guide_mock
    from pylele2.chamber import test_chamber, test_chamber_mock
    from pylele2.peg import test_peg, test_peg_mock
    from pylele2.worm import test_worm, test_worm_mock
    from pylele2.tuners import test_tuners, test_tuners_mock
    from pylele2.body import test_body, test_body_mock
    from pylele2.texts import test_texts, test_texts_mock
    from pylele2.rim import test_rim, test_rim_mock
    from pylele2.worm_key import test_worm_key, test_worm_key_mock
    from pylele2.tail import test_tail, test_tail_mock
    from pylele2.brace import test_brace, test_brace_mock
    from pylele2.soundhole import test_soundhole, test_soundhole_mock
    from pylele2.neck_bend import test_neck_bend, test_neck_bend_mock
    ...
    from pylele2.neck_assembly import test_neck_assembly, test_neck_assembly_mock
    from pylele2.top_assembly import test_top_assembly, test_top_assembly_mock
    from pylele2.bottom_assembly import (
        test_bottom_assembly,
        test_bottom_assembly_mock,
    )
    from pylele2.all_assembly import test_all_assembly, test_all_assembly_mock
